  ...
  var MovieModel = Backbone.Model.extend({
    initialize: function(options) {
      ...
      var allContents = options.app.titleMetaData.content.map(function(asset) {
        ...
        if (
          asset.content_type &&
          asset.content_type != 'Featurette' &&
          asset.content_type != 'Places'
        ) {
      ...
      var searchModel = new SearchModel({
        search_tags: options.app.titleMetaData.search_tags,
    ...
    parseDuration: function(duration) {
      if (!duration || 'NA' == duration) return undefined;
