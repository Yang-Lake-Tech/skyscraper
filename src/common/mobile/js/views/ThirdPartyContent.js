...
define(['react', 'reactDOM', 'jquery', 'underscore', 'backbone', 'hammer', 'mobilelib/views/mobileView'], function (React, ReactDOM, $, _, Backbone, Hammer, MobileView) {
    return MobileView.extend({
        ...
        render: function render() {
            ...
            ReactDOM.render(React.createElement(
                ...
                { ref: function ref(comp) {
                        _this.ThirdPartyContentView = comp;
                    } },
                React.createElement('iframe', { src: '' }),
                React.createElement('div', { className: 'third-party-content-close' })
        ...
        resume: function resume(resumeData) {
            ...
            this.handlesOrientations = resumeData.metadata.mobile.handles_orientations ? resumeData.metadata.mobile.handles_orientations.split(',') : ["portrait"];
        ...
        onThirdPartyAppLoadCompletion: function onThirdPartyAppLoadCompletion() {
